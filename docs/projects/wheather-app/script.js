...
async function fetchWeatherData(city) {
    ...
    try { 
        ...
        return { cityName, temperature, condition, iconCode, formattedLocalTime, mainCondition };
    ...
    if (city) {
        ...
        fetchWeatherData(city)
            .then(weatherData => {
                ...
                const main = weatherData.mainCondition.toLowerCase();
                if(main == "clouds"){ 
                weatherIconDisplay.src ="images copy/clouds.png" ;}
                else if(main == "clear"){ 
                weatherIconDisplay.src ="images copy/clear.png" ;}
                else if(main == "drizzle"){ 
                weatherIconDisplay.src ="images copy/drizzle.png" ;}
                else if(main == "mist"){ 
                weatherIconDisplay.src ="images copy/mist.png" ;}
                else if(main == "haze"){ 
                weatherIconDisplay.src ="images copy/mist.png" ;}
                else if(main == "rain"){ 
                weatherIconDisplay.src ="images copy/rain.png" ;}
                else if(main == "snow"){ 
                weatherIconDisplay.src ="images copy/snow.png" ;}
